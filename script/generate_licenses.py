...
def main():
    ...
    adblock_preamble = 'These licenses do not apply to any of the code ' \
        'shipped with the AIWIZE Browser, but may apply to lists downloaded ' \
        'after installation for use with the Brave Shields feature. The ' \
        'AIWIZE Browser and such lists are separate and independent works.'
    ...
    local_data_preamble = 'These licenses do not apply to any of the code ' \
        'shipped with the AIWIZE Browser, but may apply to data files ' \
        'downloaded after installation for use with various Brave features. ' \
        'The AIWIZE Browser and such data files are separate and independent ' \
        'works.'
