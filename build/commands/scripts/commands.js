...
program
  ...
  .option('--disable_brave_extension', 'disable loading the AI Wize extension')
  .option('--disable_brave_rewards_extension', 'disable loading the AI Wize Rewards extension')
  ...
  .option('--output_path [pathname]', 'use the AI Wize binary located at [pathname]')
  .arguments('[build_config]')
  .action(start.bind(null, parsedArgs.unknown))

program
  .command('pull_l10n')
  .option('--extension <extension>', 'Scope this command to localize a AI Wize extension such as greaselion')
