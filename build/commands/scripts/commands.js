...
program
  ...
  .option('--disable_brave_extension', 'disable loading the AI Wiz extension')
  .option('--disable_brave_rewards_extension', 'disable loading the AI Wiz Rewards extension')
  ...
  .option('--output_path [pathname]', 'use the AI Wiz binary located at [pathname]')
  .arguments('[build_config]')
  .action(start.bind(null, parsedArgs.unknown))

program
  .command('pull_l10n')
  .option('--extension <extension>', 'Scope this command to localize a AI Wiz extension such as greaselion')
