 ...
 * - All mappings for auto-generated AI Wiz files from the associated Chromium files.
...
function getAutoGeneratedGrdMappings() {
  if (typeof(getAutoGeneratedGrdMappings.mappings) === 'undefined') {
    ...
    // AI Wiz specific only grd and grdp files should NOT be added.
...
const l10nUtil = {
  ...
  // AI Wiz specific strings and Chromium mapped AI Wiz strings will be here.
  // But you only need to add the AI Wiz specific strings manually here.
  getAllBravePaths: () => {
...
// to Transifex.
  ...
  // with AI Wiz specific branding strings.
