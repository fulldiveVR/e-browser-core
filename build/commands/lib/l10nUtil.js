 ...
 * - All mappings for auto-generated AI Wize files from the associated Chromium files.
...
function getAutoGeneratedGrdMappings() {
  if (typeof(getAutoGeneratedGrdMappings.mappings) === 'undefined') {
    ...
    // AI Wize specific only grd and grdp files should NOT be added.
...
const l10nUtil = {
  ...
  // AI Wize specific strings and Chromium mapped AI Wize strings will be here.
  // But you only need to add the AI Wize specific strings manually here.
  getAllBravePaths: () => {
...
// to Transifex.
  ...
  // with AI Wize specific branding strings.
