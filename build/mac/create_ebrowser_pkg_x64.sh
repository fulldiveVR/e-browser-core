...
./create_pkg.sh "$APP_PATH" "/Volumes/AData/edu-browser/src/brave/build/mac/pkg-scripts" "$BUILD_PATH/Brave Browser Component.plist" "$UNSIGNED_PATH/$APP_NAME.pkg"
