APP_NAME="TauBrowser Browser"
APP_FILE="${APP_NAME}.app"
APP_VERSION="1.78.0"
CHROME_VERSION="134.1.78.0"
...
SRC_ZIP_PATH="$BUILD_PATH/dist/taubrowser-v${APP_VERSION}-darwin-${ARCH_APP}.zip"
DST_ZIP_PATH="$BUILD_PATH/dist/taubrowser-v${APP_VERSION}-darwin-${ARCH_APP}.zip"
...
codesign -s "${SIGNATURE}" -f -o runtime --timestamp "$SIGNING_APP_PATH/Contents/Library/LaunchServices/com.taubrowser.Browser.UpdaterPrivilegedHelper"
