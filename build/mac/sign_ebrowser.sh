...
PKG_PATH="$BUILD_PATH/AIWIZE Browser Packaging"
...
codesign -s "${SIGNATURE}" -f -o runtime --timestamp --entitlements "${PKG_PATH}/helper-plugin-entitlements.plist" "$FRAMEWORK_PATH/Versions/${CHROME_VERSION}/Resources/node-macos"
