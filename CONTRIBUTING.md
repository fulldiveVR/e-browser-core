...
### Help triage issues
One of the easiest ways to help is to [look through our issues tab](https://github.com/fulldiveVR/e-browser-core/issues)
...
* See our [Triage Guidelines page](https://github.com/fulldiveVR/e-browser-core/wiki/Triage-Guidelines) for more info about this process
...
* Having more clear or up-to-date instructions in the README for both [`brave-browser`](https://github.com/fulldiveVR/e-browser-core/blob/master/README.md) and [`brave-core`](https://github.com/brave/brave-core/blob/master/README.md).
* Capturing/updating helpful information [in our wiki](https://github.com/fulldiveVR/e-browser-core/wiki). You'll need to reach out to a Brave team member to request permission - you can do this by creating a new issue or tagging a Brave team member in an existing issue.
...
### Work on the code
* The [repo's wiki](https://github.com/fulldiveVR/e-browser-core/wiki) has instructions for cloning the repo and getting setup on your platform of choice
* Check out the [troubleshooting page](https://github.com/fulldiveVR/e-browser-core/wiki/Troubleshooting) if you get stuck
* Once you're up and running, find an interesting issue to fix. Check out issues labelled with [good first issue](https://github.com/fulldiveVR/e-browser-core/labels/good%20first%20issue)
...
* Submit a [ticket](https://github.com/fulldiveVR/e-browser-core/issues) for your issue if one does not already exist. Please include the Brave version, operating system, and steps to reproduce the issue.
* Fork the repository on GitHub (this might be [`brave-browser`](https://github.com/fulldiveVR/e-browser-core), [`brave-core`](https://github.com/brave/brave-core), or both).
...
* For changes which involve patches, please check out our [Patching Chromium](https://github.com/fulldiveVR/e-browser-core/wiki/Patching-Chromium) guide.
...
* the root project (this repo, [`brave-browser`](https://github.com/fulldiveVR/e-browser-core)), which pulls down all of the Chromium code into `src/`
...
* New features and most other pull requests require a new [test](https://github.com/fulldiveVR/e-browser-core/wiki/Tests) to be written before the pull request will be accepted.  Some exceptions would be a tweak to an area of code that doesn't have tests yet, text changes, build config changes, things that can't be tested due to test suite limitations, etc.
...
````
    ...
    Fix https://github.com/fulldiveVR/e-browser-core/issues/108
````
...
* a descriptive title; this gets used in the release notes ([desktop](https://github.com/fulldiveVR/e-browser-core/blob/master/CHANGELOG_DESKTOP.md) or [android](https://github.com/fulldiveVR/e-browser-core/blob/master/CHANGELOG_ANDROID.md))
...
* Some issues may need to be uplifted to other channels (Dev / Beta / Release). Please see our notes on [uplifting a pull request](https://github.com/fulldiveVR/e-browser-core/wiki/Uplifting-a-pull-request).
