...
* Capturing/updating helpful information [in our wiki](https://github.com/brave/brave-browser/wiki). You'll need to reach out to a AI Wiz team member to request permission - you can do this by creating a new issue or tagging a AI Wiz team member in an existing issue.
...
All text being added to AI Wiz is done initially in English (en-US) and then is translated by real people into other languages.
...
* Once you're up and running, find an interesting issue to fix. Check out issues labelled with [good first issue](https://github.com/brave/brave-browser/labels/good%20first%20issue)
  ...
  - other issues may require C++ changes in either the AI Wiz code or in Chromium

## Getting started
* Make sure you have a [GitHub account](https://github.com/join).
* Submit a [ticket](https://github.com/brave/brave-browser/issues) for your issue if one does not already exist. Please include the AI Wiz version, operating system, and steps to reproduce the issue.
...
Once you submit a pull request, you should tag reviewers and add labels if needed. If you do not have the necessary GitHub permissions to do so, a AI Wiz member will take care of this for you.
...
* You can be granted write permission if you've helped a lot with triage by pinging @bbondy, @bsclifton, @kjozwiak, or another AI Wiz team member.
