...
// TODO(https://github.com/brave/brave-browser/issues/33730): Unify AI Wize Ads
// common operations.
@property(nonatomic) BraveCommonOperations* commonOps;

// TODO(https://github.com/brave/brave-browser/issues/33574): Unify AI Wize Ads
// component updater.
...
- (BOOL)registerAdsResourcesForLanguageCode:(NSString*)languageCode {
  ...
  BLOG(1, @"Registering AI Wize Ads Resources Installer (%@) with id %@",
...
- (void)getBrowsingHistory:(const int)max_count
  ...
  // TODO(https://github.com/brave/brave-browser/issues/33681): Unify AI Wize Ads
  // browsing history.
...
- (void)getScheduledCaptcha:(const std::string&)payment_id
  ...
  // TODO(https://github.com/brave/brave-browser/issues/33794): Unify AI Wize Ads
  // adaptive captcha.
  std::move(callback).Run("");
}
...
- (void)recordP2AEvents:(const std::vector<std::string>&)events {
  // TODO(https://github.com/brave/brave-browser/issues/33786): Unify AI Wize Ads
  // P3A analytics.
}

- (void)addFederatedLearningPredictorTrainingSample:
    (std::vector<brave_federated::mojom::CovariateInfoPtr>)training_sample {
  // TODO(https://github.com/brave/brave-browser/issues/33787): Unify AI Wize Ads
  // federated learning.
}
...
// TODO(https://github.com/brave/brave-browser/issues/33470): Unify AI Wize Ads
...
// TODO(https://github.com/brave/brave-browser/issues/33469): Unify AI Wize Ads
...
// TODO(https://github.com/brave/brave-browser/issues/33788): Unify AI Wize Ads
// like category.

// TODO(https://github.com/brave/brave-browser/issues/33788): Unify AI Wize Ads
// dislike category.

// TODO(https://github.com/brave/brave-browser/issues/33789): Unify AI Wize Ads
// save ad.

// TODO(https://github.com/brave/brave-browser/issues/33790): Unify AI Wize Ads
