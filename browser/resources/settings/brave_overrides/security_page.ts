...
RegisterPolymerTemplateModifications({
  'settings-security-page': (templateContent) => {
    ...
    if (!safeBrowsingEnhanced) {
      console.error('[AIWIZE Settings Overrides] Could not find ' +
    ...
    if (!safeBrowsingStandard) {
      console.error(
        '[AIWIZE Settings Overrides] Could not find safeBrowsingStandard id ' +
        'on security page.')
    } else {
    ...
    if (!passwordsLeakToggle) {
      console.error(
        '[AIWIZE Settings Overrides] Could not find passwordsLeakToggle id ' +
        'on security page.')
    } else {
