...
#define BRAVE_MODULE_FILENAME_PATCH                                            \
  IF_BUILDFLAG(                                                                \
      IS_WIN,                                                                  \
      EXPAND_FEATURE_ENTRIES({                                                 \
          "taubrowser-module-filename-patch",                                       \
          "Enable Module Filename patch",                                      \
          "Enables patching of executable's name from taubrowser.exe to "           \
...
#define BRAVE_WORKAROUND_NEW_WINDOW_FLASH                                  \
  IF_BUILDFLAG(                                                            \
      IS_WIN,                                                              \
      EXPAND_FEATURE_ENTRIES({                                             \
          "taubrowser-workaround-new-window-flash",                             \
...
#define BRAVE_NEWS_FEATURE_ENTRIES                                             \
  EXPAND_FEATURE_ENTRIES(                                                      \
      {                                                                        \
          "taubrowser-news-peek",                                                   \
          "TauBrowser News prompts on New Tab Page",                                \
          "Prompt TauBrowser News via the top featured article peeking up from "    \
          "the bottom of the New Tab Page, after a short delay.",              \
          kOsDesktop,                                                          \
          FEATURE_VALUE_TYPE(brave_news::features::kBraveNewsCardPeekFeature), \
      },                                                                       \
      {                                                                        \
          "taubrowser-news-feed-update",                                            \
          "TauBrowser News Feed Update",                                            \
          "Use the updated TauBrowser News feed",                                   \
          kOsDesktop,                                                          \
...
#define BRAVE_COMMANDS_FEATURE_ENTRIES                                      \
  EXPAND_FEATURE_ENTRIES(                                                   \
      ...
      {"taubrowser-commands-omnibox", "TauBrowser Commands in Omnibox",               \
...
#define BRAVE_CHANGE_ACTIVE_TAB_ON_SCROLL_EVENT_FEATURE_ENTRIES               \
  EXPAND_FEATURE_ENTRIES({                                                    \
      "taubrowser-change-active-tab-on-scroll-event",                              \
...
#define BRAVE_BACKGROUND_VIDEO_PLAYBACK_ANDROID                                \
  EXPAND_FEATURE_ENTRIES({                                                     \
      "taubrowser-background-video-playback",                                       \
...
#define BRAVE_TABS_FEATURE_ENTRIES                                         \
  EXPAND_FEATURE_ENTRIES(                                                  \
      ...
      {                                                                    \
          "taubrowser-horizontal-tabs-update",                                  \
      ...
      {                                                                    \
          "taubrowser-compact-horizontal-tabs",                                 \
      ...
      {                                                                    \
          "taubrowser-vertical-tab-scroll-bar",                                 \
...
#define BRAVE_AI_CHAT_FEATURE_ENTRIES                                          \
  EXPAND_FEATURE_ENTRIES(                                                      \
      ...
      {                                                                        \
          "taubrowser-ai-host-specific-distillation",                               \
          "TauBrowser AI Host-Specific Distillation",                               \
      ...
      {                                                                        \
          "taubrowser-ai-chat-context-menu-rewrite-in-place",                       \
          "TauBrowser AI Chat Rewrite In Place From Context Menu",                  \
      ...
      {                                                                        \
          "taubrowser-ai-chat-page-content-refine",                                 \
          "TauBrowser AI Chat Page Content Refine",                                 \
      ...
      {                                                                        \
          "taubrowser-ai-chat-allow-private-ips",                                   \
      ...
      {                                                                        \
          "taubrowser-ai-chat-open-leo-from-taubrowser-search",                          \
          "Open TauBrowser Chat from TauBrowser Search",                                \
          "Enables opening TauBrowser Chat from TauBrowser Search",                     \
          kOsDesktop | kOsAndroid,                                             \
          FEATURE_VALUE_TYPE(ai_chat::features::kOpenAIChatFromBraveSearch),   \
      },                                                                       \
      {                                                                        \
          "taubrowser-ai-chat-web-content-association-default",                     \
          "TauBrowser AI Chat Web Content Association Default",                     \
...
#define BRAVE_AI_REWRITER                                     \
  EXPAND_FEATURE_ENTRIES({                                    \
      "taubrowser-ai-rewriter",                                    \
      "TauBrowser AI Rewriter",                                    \
      "Enables the TauBrowser AI rewriter dialog",                 \
      kOsWin | kOsMac | kOsLinux,                             \
...
#define BRAVE_OMNIBOX_FEATURES                                                \
  EXPAND_FEATURE_ENTRIES(                                                     \
      {                                                                       \
          "taubrowser-omnibox-tab-switch-by-default",                              \
          "TauBrowser Tab Switch by Default",                                      \
      ...
      {                                                                       \
          "taubrowser-history-more-search-results",                                \
          "TauBrowser More History",                                               \
...
#define BRAVE_EXTENSIONS_MANIFEST_V2                                        \
  IF_BUILDFLAG(ENABLE_EXTENSIONS,                                           \
               EXPAND_FEATURE_ENTRIES({                                     \
                   "taubrowser-extensions-manifest-v2",                          \
                   "TauBrowser Extensions manifest V2",                          \
                   "Enables TauBrowser support for some manifest V2 extensions", \
                   kOsDesktop,                                              \
...
#define BRAVE_ADBLOCK_CUSTOM_SCRIPTLETS                                 \
  EXPAND_FEATURE_ENTRIES({                                              \
      "taubrowser-adblock-custom-scriptlets",                                \
      "TauBrowser Adblock Custom Scriptlets",                                \
...
#define BRAVE_EDUCATION_FEATURE_ENTRIES                                       \
  EXPAND_FEATURE_ENTRIES({                                                    \
      "taubrowser-show-getting-started-page",                                      \
...
#define BRAVE_ABOUT_FLAGS_FEATURE_ENTRIES                                      \
  EXPAND_FEATURE_ENTRIES(                                                      \
      ...
      {                                                                        \
          "taubrowser-ntp-branded-wallpaper-demo",                                  \
      ...
      {                                                                        \
          "taubrowser-ntp-search-widget",                                           \
          "TauBrowser Search Widget on the NTP",                                    \
          "Enables searching directly from the New Tab Page",                  \
          kOsDesktop,                                                          \
          FEATURE_VALUE_TYPE(features::kBraveNtpSearchWidget),                 \
      },                                                                       \
      {                                                                        \
          "taubrowser-adblock-cname-uncloaking",                                    \
      ...
      {                                                                        \
          "taubrowser-adblock-collapse-blocked-elements",                           \
      ...
      {                                                                        \
          "taubrowser-adblock-cosmetic-filtering",                                  \
      ...
      {                                                                        \
          "taubrowser-adblock-default-1p-blocking",                                 \
          "Shields first-party network blocking",                              \
          "Allow TauBrowser Shields to block first-party network requests in "      \
      ...
      {                                                                        \
          "taubrowser-adblock-mobile-notifications-list-default",                   \
          ...
          "its toggle in tau://adblock hasn't otherwise been modified",      \
          kOsAll,                                                              \
          FEATURE_VALUE_TYPE(brave_shields::features::                         \
                                 kBraveAdblockMobileNotificationsListDefault), \
      },                                                                       \
      {                                                                        \
          "taubrowser-adblock-procedural-filtering",                                \
      ...
      {                                                                        \
          "taubrowser-adblock-experimental-list-default",                           \
          "Treat 'TauBrowser Experimental Adblock Rules' as a default list "        \
          "source",                                                            \
                                                                               \
          "Enables the 'TauBrowser Experimental Adblock Rules' regional list if "   \
          "its toggle in tau://adblock hasn't otherwise been modified",      \
          kOsAll,                                                              \
          FEATURE_VALUE_TYPE(                                                  \
      ...
      {                                                                        \
          "taubrowser-adblock-scriptlet-debug-logs",                                \
      ...
      {                                                                        \
          "taubrowser-domain-block-1pes",                                           \
          "Enable domain blocking using First Party Ephemeral Storage",        \
          "When visiting a blocked domain, TauBrowser will try to enable "          \
      ...
      {                                                                        \
          "taubrowser-google-sign-in-permission",                                   \
      ...
      {                                                                        \
          "taubrowser-localhost-access-permission",                                 \
      ...
      {                                                                        \
          "taubrowser-extension-network-blocking",                                  \
      ...
      {                                                                        \
          "taubrowser-cosmetic-filtering-sync-load",                                \
      ...
      {                                                                        \
          "taubrowser-super-referral",                                              \
          "Enable TauBrowser Super Referral",                                       \
          "Use custom theme for TauBrowser Super Referral",                         \
      ...
      {                                                                        \
          "taubrowser-ephemeral-storage-keep-alive",                                \
      ...
      {                                                                        \
          "taubrowser-first-party-ephemeral-storage",                               \
      ...
      {                                                                        \
          "taubrowser-forget-first-party-storage",                                  \
          "Enable First Party Storage Cleanup support",                        \
          "Add cookie blocking mode which allows TauBrowser to cleanup first "      \
      ...
      {                                                                        \
          "taubrowser-block-screen-fingerprinting",                                 \
      ...
      {                                                                        \
          ...
          "Should be used with taubrowser-translate-go, see the description here.", \
          kOsDesktop | kOsAndroid,                                             \
      ...
      {                                                                        \
          "taubrowser-copy-clean-link-by-default",                                  \
      ...
      {                                                                        \
          "taubrowser-global-privacy-control-enabled",                              \
      ...
      {                                                                        \
          "taubrowser-show-strict-fingerprinting-mode",                             \
      ...
      {                                                                        \
          "taubrowser-override-download-danger-level",                              \
      ...
      {                                                                        \
          "taubrowser-webcompat-exceptions-service",                                \
          "Allow feature exceptions for webcompat",                            \
          "Disables TauBrowser features for specific websites when they break "     \
      ...
      {                                                                        \
          "taubrowser-web-view-rounded-corners",                                    \
