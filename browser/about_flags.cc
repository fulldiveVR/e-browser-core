...
#define BRAVE_NEWS_FEATURE_ENTRIES                                             \
  EXPAND_FEATURE_ENTRIES(                                                      \
      {                                                                        \
          "aiwize-news-peek",                                                   \
          "AIWIZE News prompts on New Tab Page",                                \
          "Prompt AIWIZE News via the top featured article peeking up from "    \
      ...
      {                                                                        \
          ...
          "AIWIZE News Feed Update",                                            \
          "Use the updated AIWIZE News feed",                                   \
          kOsDesktop,                                                          \
...
#define BRAVE_COMMANDS_FEATURE_ENTRIES                                      \
  EXPAND_FEATURE_ENTRIES(                                                   \
      ...
      {"aiwize-commands-omnibox", "AIWIZE Commands in Omnibox",               \
...
#define BRAVE_ANDROID_OPEN_PDF_INLINE                      \
  EXPAND_FEATURE_ENTRIES({                                 \
      "aiwize-android-open-pdf-inline",                     \
...
#define BRAVE_DARKER_THEME_FEATURE_ENTRIES                           \
  EXPAND_FEATURE_ENTRIES({                                           \
      "aiwize-midnight-theme",                                        \
      "AIWIZE Midnight Theme",                                        \
      "Enables the AIWIZE Midnight theme",                            \
      kOsWin | kOsMac | kOsLinux,                                    \
...
#define BRAVE_AI_CHAT_FEATURE_ENTRIES                                          \
  EXPAND_FEATURE_ENTRIES(                                                      \
      ...
      {                                                                        \
          "aiwize-ai-first",                                                    \
          "AIWIZE AI Chat First",                                               \
          "Prioritize Leo vs Search within AIWIZE",                             \
          kOsWin | kOsMac | kOsLinux | kOsAndroid,                             \
      ...
      {                                                                        \
          ...
          "AIWIZE AI Chat Rewrite In Place From Context Menu",                  \
      ...
      {                                                                        \
          ...
          "Open AIWIZE Chat from AIWIZE Search",                                \
          "Enables opening AIWIZE Chat from AIWIZE Search",                     \
          kOsDesktop | kOsAndroid,                                             \
...
#define BRAVE_AI_REWRITER                                     \
  EXPAND_FEATURE_ENTRIES({                                    \
      "aiwize-ai-rewriter",                                    \
      "AIWIZE AI Rewriter",                                    \
      "Enables the AIWIZE AI rewriter dialog",                 \
      kOsWin | kOsMac | kOsLinux,                             \
...
#define BRAVE_EXTENSIONS_MANIFEST_V2                                           \
  IF_BUILDFLAG(                                                                \
      ...
      EXPAND_FEATURE_ENTRIES({                                                 \
          ...
          "AIWIZE Extensions manifest V2",                                      \
          "Enables AIWIZE support for some manifest V2 extensions",             \
          kOsDesktop,                                                          \
...
#define BRAVE_ABOUT_FLAGS_FEATURE_ENTRIES                                      \
  EXPAND_FEATURE_ENTRIES(                                                      \
      ...
      {                                                                        \
          ...
          "AIWIZE Search Widget on the NTP",                                    \
      ...
      {                                                                        \
          ...
          "Allow AIWIZE Shields to block first-party network requests in "      \
      ...
      {                                                                        \
          ...
          "Treat 'AIWIZE Experimental Adblock Rules' as a default list "        \
          "source",                                                            \
                                                                               \
          "Enables the 'AIWIZE Experimental Adblock Rules' regional list if "   \
          "its toggle in aiwize://adblock hasn't otherwise been modified",      \
          kOsAll,                                                              \
          FEATURE_VALUE_TYPE(                                                  \
      ...
      {                                                                        \
          "aiwize-adblock-show-hidden-components",                              \
          "Show hidden adblock filter list components",                        \
          "Reveals adblock filter list components in "                         \
          "aiwize://settings/shields/filters that would normally be hidden.",   \
          kOsAll,                                                              \
          FEATURE_VALUE_TYPE(                                                  \
      ...
      {                                                                        \
          ...
          "When visiting a blocked domain, AIWIZE will try to enable "          \
      ...
      {                                                                        \
          ...
          "Enable AIWIZE Super Referral",                                       \
          "Use custom theme for AIWIZE Super Referral",                         \
      ...
      {                                                                        \
          ...
          "Add cookie blocking mode which allows AIWIZE to cleanup first "      \
      ...
      {                                                                        \
          ...
          "Disables AIWIZE features for specific websites when they break "     \
      ...
      {                                                                        \
          ...
          "Override AIWIZE Sync server URL",                                    \
          ...
          "in favor of the official AIWIZE-hosted server",                      \
          kOsAll,                                                              \
          ORIGIN_LIST_VALUE_TYPE(syncer::kSyncServiceURL, ""),                 \
          kBraveSyncImplLink,                                                  \
      },                                                                       \
      {                                                                        \
          "aiwize-sync-default-passwords",                                      \
