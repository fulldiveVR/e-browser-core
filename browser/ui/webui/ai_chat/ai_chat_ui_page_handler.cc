...
constexpr char kURLRefreshPremiumSession[] =
    "https://account.tau-browser.ru/?intent=recover&product=leo";
...
constexpr char kURLGoPremium[] =
    "https://account.tau-browser.ru/account/?intent=checkout&product=leo";
constexpr char kURLManagePremium[] = "https://account.tau-browser.ru/";
#endif
}  // namespace
...
#if !BUILDFLAG(IS_ANDROID)
  const GURL url("tau://settings/taubrowser-chat");
