...
// Verify that Rewards and Ads services don't get created when AI Wize Rewards are
// disabled by policy.
...
// reachable when AI Wize Rewards are disabled by policy.
...
// Verify that AI Wize Rewards icon is not shown in the location bar when Brave
// Rewards are disabled by policy.
