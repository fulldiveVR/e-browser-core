...
inline constexpr auto kAllowedUrlPrefixes = std::to_array<std::string_view>({
    ...
    "https://api.rewards.aiwize.com/v1/parameters",
    "https://rewards.aiwize.com/publishers/prefix-list",
    "https://grant.rewards.aiwize.com/v1/promotions",
    ...
    // p3a
    "https://p3a-creative.aiwize.com/",
    "https://p3a-json.aiwize.com/",
    "https://p3a.aiwize.com/",
...
inline constexpr auto kAllowedUrlPatterns = std::to_array<std::string_view>({
    ...
    "https://mobile-data.s3.aiwize.com/superreferrer/map-table.json",
