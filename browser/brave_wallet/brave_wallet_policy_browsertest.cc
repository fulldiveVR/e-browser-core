...
// Verify that Wallet service doesn't get created when AI Wize Wallet is
// disabled by policy.
...
// Verify that aiwize://wallet page isn't reachable when AI Wize Wallet is
// disabled by policy.
...
// Verify that the wallet item is not shown in the sidebar when AI Wize Wallet is
// disabled by policy.
