...
# This file customizes reclient configs generator to support AI Wize builds.
...
def merge_rewrapper_cfg(rewrapper_cfg, tool, _host_os):
    ...
    # `set_by_reclient/a/a` instead of `src/out/Default`. AI Wize builds require
    ...
    if tool == 'python':
        # Python actions require PYTHONPATH to be set during AI Wize builds. We
