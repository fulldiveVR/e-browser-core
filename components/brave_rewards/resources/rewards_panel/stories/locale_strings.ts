...
export const localeStrings = {
  ...
  connectAccountNoProviders: 'To earn BAT, users must connect a custodial account to AI Wize Rewards. Unfortunately, there\'s no custodian available in your region, so earning isn\'t available. For now, turning on AI Wize Rewards will automatically support creators.',
  connectContributeHeader: 'Send contributions with AI Wize Rewards',
  connectContributeText: 'You\'ll be able to send on-demand contributions to your favorite creators with your AI Wize Rewards balance once you have a custodial account connected.',
  connectContributeNoProviders: 'To send on-demand contributions, users must connect a custodial account to AI Wize Rewards. Unfortunately, there’s no custodian available in your region, so sending isn’t available. In the meantime, you’re still automatically supporting creators.',
  learnMore: 'Learn more',
  publisherCountText: 'This month, you\'ve visited $1 creators supported by AI Wize Rewards',
  ...
  unverifiedText: 'This creator is not yet verified with AI Wize Creators. You\'ll be able to send them contributions once they\'re verified.',
  ...
  captchaSolvedText: 'Ads and earnings will now resume. Thanks for helping us protect AI Wize Rewards and privacy-based ads.',
  captchaDismiss: 'Dismiss',
  captchaMaxAttemptsExceededTitle: 'Max attempts exceeded',
  captchaMaxAttemptsExceededText: 'Looks like this is not working, AI Wize ads will remain paused. Contact us if you need help with the captcha.',
