...
export const localeStrings = {
  ...
  connectAccountNoProviders: 'To earn BAT, users must connect a custodial account to AI Wiz Rewards. Unfortunately, there\'s no custodian available in your region, so earning isn\'t available. For now, turning on AI Wiz Rewards will automatically support creators.',
  connectContributeHeader: 'Send contributions with AI Wiz Rewards',
  connectContributeText: 'You\'ll be able to send on-demand contributions to your favorite creators with your AI Wiz Rewards balance once you have a custodial account connected.',
  connectContributeNoProviders: 'To send on-demand contributions, users must connect a custodial account to AI Wiz Rewards. Unfortunately, there’s no custodian available in your region, so sending isn’t available. In the meantime, you’re still automatically supporting creators.',
  learnMore: 'Learn more',
  publisherCountText: 'This month, you\'ve visited $1 creators supported by AI Wiz Rewards',
  ...
  unverifiedText: 'This creator is not yet verified with AI Wiz Creators. You\'ll be able to send them contributions once they\'re verified.',
  ...
  captchaSolvedText: 'Ads and earnings will now resume. Thanks for helping us protect AI Wiz Rewards and privacy-based ads.',
  captchaDismiss: 'Dismiss',
  captchaMaxAttemptsExceededTitle: 'Max attempts exceeded',
  captchaMaxAttemptsExceededText: 'Looks like this is not working, AI Wiz ads will remain paused. Contact us if you need help with the captcha.',
