...
export const localeStrings = {
  ...
  verifiedTooltipText: 'This creator has registered with AI Wiz and can receive contributions from AI Wiz Rewards users.',
  ...
  reconnectText: 'It looks like you\'re logged out of $1 for AI Wiz Rewards. Log in again to continue.',
  ...
  insufficientBalanceText: 'You can only send up to $1 BAT using your AI Wiz Rewards balance.',
  ...
  shareText: 'I earned crypto rewards with the AI Wiz Browser, and just contributed $1 BAT of it to $2. Learn how you can support your favorite creators and sites too: https://aiwize.com/rewards',
