...
export const localeStrings = {
  ...
  adsSubdivisionTargetingDescription: 'This allows AI Wize to show you ads meant specifically for your region.',
  adsSubdivisionTargetingLearn: 'Learn More',
  adsDescription: 'Control what kinds of AI Wize Ads you see, and how often.',
  ...
  settings: 'Settings',
  rewardsBrowserCannotReceiveAds: 'Oops! Your browser cannot receive AI Wize Private Ads.',
  ...
  connectAccountNoProviders: 'To start earning BAT, you need to connect a custodial account to AI Wize Rewards. Unfortunately, there\'s no custodian available in your region, so earning isn\'t available at this time. However, you\'ll still be automatically supporting creators by using Rewards.',
