...
export default class BoxMobile extends React.PureComponent<Props, State> {
   ...
   *
   * When user is on the index page: (aiwize://rewards)
   * (state) { detailView: false, settings: false }
   *
   * When user is on a detail view: (aiwize://rewards/ads)
   * (state) { detailView: true, settings: false }
   *
   * When user is on a settings view: (aiwize://rewards/ads-settings)
