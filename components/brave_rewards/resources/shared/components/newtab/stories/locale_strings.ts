...
export const localeStrings = {
  ...
  rewardsConnectAccountNoProviders: 'To start earning BAT, you need to connect a custodial account to AI Wiz Rewards. Unfortunately, there’s no custodian available in your region, so earning isn’t available at this time. However, you’ll still be automatically supporting creators by using Rewards.',
  ...
  rewardsEarningInfoText: 'This reflects your estimated earnings range for AI Wiz Ads this month.',
  ...
  rewardsPublisherCountText: 'This month, you\'ve visited $1 creators supported by AI Wiz Rewards',
  rewardsSelectCountryHeader: 'Select your country',
  rewardsSelectCountryText: 'To continue using AI Wiz Rewards, select your country so we can show you the right options and ads for your region. $1Privacy Policy$2',
