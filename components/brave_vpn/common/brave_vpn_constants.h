...
inline constexpr char kManageUrlProd[] = "https://account.tau-browser.ru/account/";
...
inline constexpr char kFeedbackUrl[] = "https://support.tau-browser.ru/";
inline constexpr char kAboutUrl[] = "https://tau-browser.ru/firewall-vpn/";
