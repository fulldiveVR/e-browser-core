...
provideStrings({
  ...
  braveVpnPurchased: 'Already purchased AIWIZE VPN?',
  ...
  braveVpnPaymentFailureReason:
    'Looks like your most recent payment for $1 did not go through. Access to this subscription will pause until the payment issue is resolved. Try to edit your payment method, or contact AIWIZE support.',
  ...
  braveVpnConnectNotAllowed:
    'VPN connection failed. Please try connecting again, and be sure to click "Allow" to enable AIWIZE\'s VPN configuration.',
  braveVpnSessionExpiredTitle: 'Session expired',
  braveVpnSessionExpiredContent:
    'Please log in to your $1AIWIZE Account/$1 to refresh your VPN session.',
  braveVpnWidgetTitle: 'AIWIZE VPN',
