...
inline constexpr char kRequestOTRActionOption[] =
    "aiwize.request_otr.request_otr_action_option";
inline constexpr char kInterstitialShownStorage[] =
    "aiwize.request_otr.p3a.interstitial_shown_storage";
inline constexpr char kInterstitialDurationStorage[] =
    "aiwize.request_otr.p3a.interstitial_duration_storage";
inline constexpr char kSessionCountStorage[] =
    "aiwize.request_otr.p3a.session_count_storage";
