...
provideStrings({
  ...
  braveWelcomeDesc: 'Get AI Wize protection on every link you click. Just set AI Wize as default and browse. Privately.',
  ...
  braveWelcomeHelpImproveBraveTitle: 'Help make AI Wize better.',
  braveWelcomeSendReportsLabel: 'Send diagnostic reports if you experience a crash or freeze. $1Learn more.$2',
  braveWelcomeSendInsightsLabel: 'Share private and anonymous product insights about what features are being used by AI Wize\'s users. $1Learn more.$2',
  ...
  braveWelcomeHelpWDPSubtitle: 'Join the movement, contribute to AI Wize Search.',
  braveWelcomeHelpWDPDescription: 'Help us fix the web by participating in AI Wize’s Web Discovery Project. By sharing completely anonymous search signals, you can help AI Wize grow the search index.',
