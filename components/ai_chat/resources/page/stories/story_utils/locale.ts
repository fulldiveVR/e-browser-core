...
provideStrings({
  ...
  aboutTitle: 'About AI Wize Chat',
  aboutDescription: 'AI Wize Chat is an AI smart assistant that can summarize web pages, transcribe videos, and answer questions. AI Wize Chat Premium uses advanced $1AI models$2 for even more nuanced replies, and gives early access to new features.',
  ...
  aboutDescription_3: 'AI Wize Chat does not collect or otherwise process identifiers such as IP Address that can be linked to you. No personal data is retained by the AI model or any 3rd-party model providers.',
  acceptButtonLabel: 'Accept and begin',
  pageContentWarning: 'Disconnect to stop sending this page content to AI Wize Chat, and start a new conversation',
  ...
  braveLeoAssistantEndpointValidAsPrivateIp: 'If you would like to use a private IP address, you must first enable "Private IP Addresses for Custom Model Enpoints" via aiwize://flags/#brave-ai-chat-allow-private-ips',
  retryButtonLabel: 'Retry',
  learnMore: 'Learn more',
  noticeConversationHistoryBody: 'AI Wize Chat will now remember your previous conversations so you can go back to them. They are stored privately on your device, and you can delete them any time.',
  ...
  noticeConversationHistoryDisabledPref: 'In order to view and search your previous conversations with AI Wize Chat, you need to enable conversation history.',
  ...
  premiumLabel: 'AI Wize Chat Premium',
  premiumPricing: 'USD \$ $1 / month',
  premiumAnnualPricing: 'USD \$ $1 / year',
  monthlyLabel: 'Monthly',
  onYearLabel: 'One year',
  bestValueLabel: 'Best value',
  unlockPremiumTitle: 'Unleash AI Wize Chat\'s full powers with Premium:',
  ...
  provideFeedbackTitle: 'Provide AI Wize AI Feedback',
  ...
  feedbackPremiumNote: 'AI Wize Chat Premium provides access to an expanded set of language models for even greater answer nuance. $1Learn more$2',
  ...
  premiumRefreshWarningDescription: 'Your AI Wize account session has expired. Please visit your account page to refresh, then come back to use premium features.',
  premiumRefreshWarningAction: 'Refresh',
  switchToBasicModelButtonLabel: 'Switch to the free model',
  clearChatButtonLabel: 'Clear chat',
  errorContextLimitReaching: 'This conversation is long and AI Wize Chat may start forgetting things soon. You can get longer conversations by switching to a premium model, or you can clear the chat to reset it',
  ...
  pageContentTooLongWarning: 'The page is too long for AI Wize Chat. Some context could be missing from the conversation. AI Wize Chat was able to read $1 of the page\'s contents.',
  errorConversationEnd: 'This conversation is too long and cannot continue. There may be other models available with which AI Wize Chat is capable of maintaining accuracy for longer conversations.',
  searchInProgress: 'Improving your answer with AI Wize Search…',
  searchQueries: 'Improved answer searching for $1.',
  sources: 'Sources',
  expandSources: '$1 more…',
  leoSettingsTooltipLabel: 'AI Wize Chat settings',
  summarizePageButtonLabel: 'Summarize this page',
  welcomeGuideTitle: 'Hi, I\'m AI Wize Chat!',
  welcomeGuideSubtitle: 'An AI-powered intelligent assistant, built right into AI Wize',
  ...
  contextToggleTooltipInfo: 'Toggle on to ask about this page. It\'s content will be sent to AI Wize Chat along with your messages.',
  ...
  toolsMenuButtonLabel: 'AI Wize Chat tools',
  sendChatButtonLabel: 'Send message to AI Wize Chat',
