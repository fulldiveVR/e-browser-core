...
provideStrings({
  ...
  aboutDescription: 'Brave Leo is an AI smart assistant that can summarize web pages, transcribe videos, and answer questions. AI Wiz Leo Premium uses advanced $1AI models$2 for even more nuanced replies, and gives early access to new features.',
  ...
  provideFeedbackTitle: 'Provide AI Wiz AI Feedback',
  ...
  premiumRefreshWarningDescription: 'Your AI Wiz account session has expired. Please visit your account page to refresh, then come back to use premium features.',
  ...
  contextToggleTooltipInfo: 'Toggle on to ask about this page. It\'s content will be sent to AI Wiz Leo along with your messages.'
})
