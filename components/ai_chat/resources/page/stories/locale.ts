...
provideStrings({
  ...
  aboutDescription: 'Brave Leo is an AI smart assistant that can summarize web pages, transcribe videos, and answer questions. AI Wize Leo Premium uses advanced $1AI models$2 for even more nuanced replies, and gives early access to new features.',
  ...
  contextToggleTooltipInfo: 'Toggle on to ask about this page. It\'s content will be sent to AI Wize Leo along with your messages.'
})
