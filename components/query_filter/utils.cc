...
static constexpr auto kSimpleQueryStringTrackers =
    base::MakeFixedFlatSet<std::string_view>(
        base::sorted_unique,
        {
            // https://github.com/fulldiveVR/e-browser-core/issues/9019
            "__hsfp",
            "__hssc",
            "__hstc",
            // https://github.com/fulldiveVR/e-browser-core/issues/8975
            "__s",
            // https://github.com/fulldiveVR/e-browser-core/issues/33188
            "_gl",
            // https://github.com/fulldiveVR/e-browser-core/issues/9019
            "_hsenc",
            // https://github.com/fulldiveVR/e-browser-core/issues/34578
            "_kx",
            // https://github.com/fulldiveVR/e-browser-core/issues/11579
            "_openstat",
            // https://github.com/fulldiveVR/e-browser-core/issues/32488
            "at_recipient_id",
            "at_recipient_list",
            // https://github.com/fulldiveVR/e-browser-core/issues/25238
            "bsft_clkid",
            "bsft_uid",
            // https://github.com/fulldiveVR/e-browser-core/issues/9879
            "dclid",
            // https://github.com/fulldiveVR/e-browser-core/issues/33984
            "fb_action_ids",
            "fb_comment_id",
            // https://github.com/fulldiveVR/e-browser-core/issues/4239
            "fbclid",
            // https://github.com/fulldiveVR/e-browser-core/issues/18758
            "gbraid",
            // https://github.com/fulldiveVR/e-browser-core/issues/4239
            "gclid",
            // https://github.com/fulldiveVR/e-browser-core/issues/25691
            "guce_referrer",
            "guce_referrer_sig",
            // https://github.com/fulldiveVR/e-browser-core/issues/9019
            "hsCtaTracking",
            // https://github.com/fulldiveVR/e-browser-core/issues/33952
            "irclickid",
            // https://github.com/fulldiveVR/e-browser-core/issues/4239
            "mc_eid",
            // https://github.com/fulldiveVR/e-browser-core/issues/17507
            "ml_subscriber",
            "ml_subscriber_hash",
            // https://github.com/fulldiveVR/e-browser-core/issues/4239
            "msclkid",
            // https://github.com/fulldiveVR/e-browser-core/issues/31084
            "mtm_cid",
            // https://github.com/fulldiveVR/e-browser-core/issues/22082
            "oft_c",
            "oft_ck",
            "oft_d",
            "oft_id",
            ...
            "oft_lk",
            "oft_sk",
            // https://github.com/fulldiveVR/e-browser-core/issues/13644
            "oly_anon_id",
            "oly_enc_id",
            // https://github.com/fulldiveVR/e-browser-core/issues/31084
            "pk_cid",
            // https://github.com/fulldiveVR/e-browser-core/issues/17451
            "rb_clickid",
            // https://github.com/fulldiveVR/e-browser-core/issues/17452
            "s_cid",
            // https://github.com/fulldiveVR/e-browser-core/issues/24988
            "ss_email_id",
            // https://github.com/fulldiveVR/e-browser-core/issues/18020
            "twclid",
            // https://github.com/fulldiveVR/e-browser-core/issues/33172
            "unicorn_click_id",
            // https://github.com/fulldiveVR/e-browser-core/issues/11817
            "vero_conv",
            "vero_id",
            // https://github.com/fulldiveVR/e-browser-core/issues/26295
            "vgo_ee",
            // https://github.com/fulldiveVR/e-browser-core/issues/18758
            "wbraid",
            // https://github.com/fulldiveVR/e-browser-core/issues/13647
            "wickedid",
            // https://github.com/fulldiveVR/e-browser-core/issues/11578
            "yclid",
            // https://github.com/fulldiveVR/e-browser-core/issues/33216
            "ymclid",
            "ysclid",
        });
...
static constexpr auto kConditionalQueryStringTrackers =
    base::MakeFixedFlatMap<std::string_view, std::string_view>({
        // https://github.com/fulldiveVR/e-browser-core/issues/30731
        {"h_sid", "/email/"},
        {"h_slt", "/email/"},
        // https://github.com/fulldiveVR/e-browser-core/issues/9018
...
static const auto kScopedQueryStringTrackers =
    std::map<std::string_view, std::vector<std::string_view>>({
        // https://github.com/fulldiveVR/e-browser-core/issues/35094
        {"igsh", {"instagram.com"}},
        // https://github.com/fulldiveVR/e-browser-core/issues/11580
        {"igshid", {"instagram.com"}},
        // https://github.com/fulldiveVR/e-browser-core/issues/26966
        {"ref_src", {"twitter.com", "x.com"}},
        {"ref_url", {"twitter.com", "x.com"}},
        // https://github.com/fulldiveVR/e-browser-core/issues/34719
