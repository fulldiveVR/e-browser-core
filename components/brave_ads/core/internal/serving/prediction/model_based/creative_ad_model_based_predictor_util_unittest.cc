...
TEST_F(BraveAdsCreativeAdModelBasedPredictorUtilTest,
  ...
  CreativeNotificationAdInfo creative_ad_4 =
      test::BuildCreativeNotificationAd(/*should_use_random_uuids=*/
                                        true);
  creative_ad_4.segment = kUntargetedSegment;
  ...
  expected_creative_ad_predictor_1.input_variable.intent_segment
      .untargeted_matches.value = false;
  ...
  CreativeAdModelBasedPredictorInfo<CreativeNotificationAdInfo>
      expected_creative_ad_predictor_4;
  expected_creative_ad_predictor_4.creative_ad = creative_ad_4;
  expected_creative_ad_predictor_4.input_variable.intent_segment
      .untargeted_matches.value = true;
  expected_creative_ad_predictor_4.input_variable.intent_segment.child_matches
      .value = false;
  expected_creative_ad_predictor_4.input_variable.intent_segment.parent_matches
      .value = false;
  expected_creative_ad_predictor_4.input_variable.latent_interest_segment
      .untargeted_matches.value = true;
  expected_creative_ad_predictor_4.input_variable.latent_interest_segment
      .child_matches.value = false;
  expected_creative_ad_predictor_4.input_variable.latent_interest_segment
      .parent_matches.value = false;
  expected_creative_ad_predictor_4.input_variable.interest_segment
      .untargeted_matches.value = true;
  expected_creative_ad_predictor_4.input_variable.interest_segment.child_matches
      .value = false;
  expected_creative_ad_predictor_4.input_variable.interest_segment
      .parent_matches.value = false;
  expected_creative_ad_predictor_4.score = 5.0;
  expected_creative_ad_predictors.push_back(expected_creative_ad_predictor_4);
