    ...
    kBraveShieldsAdBlockSubscriptionTrafficAnnotation =
        ...
        semantics {
          ...
          description:
            ...
            "added by users on aiwize://adblock."
          trigger:
            "After being registered in aiwize://adblock, any enabled filter "
            "list subscriptions will be updated in accordance with their "
            "`Expires` field if present, or daily otherwise. A manual refresh "
            "for a particular list can also be triggered in aiwize://adblock."
          data: "The URL endpoint provided by the user in aiwize://adblock to "
        ...
        policy {
          ...
          setting:
            ...
            "aiwize://adblock page's custom list subscription section."
