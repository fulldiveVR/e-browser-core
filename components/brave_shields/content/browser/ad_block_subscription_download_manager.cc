    ...
    kBraveShieldsAdBlockSubscriptionTrafficAnnotation =
        ...
        semantics {
          ...
          description:
            ...
            "added by users on tau://adblock."
          trigger:
            "After being registered in tau://adblock, any enabled filter "
            "list subscriptions will be updated in accordance with their "
            "`Expires` field if present, or daily otherwise. A manual refresh "
            "for a particular list can also be triggered in tau://adblock."
          data: "The URL endpoint provided by the user in tau://adblock to "
        ...
        policy {
          ...
          setting:
            ...
            "tau://adblock page's custom list subscription section."
