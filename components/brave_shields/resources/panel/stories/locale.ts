...
provideStrings({
  braveShields: 'AIWIZE Shields',
  braveShieldsStandalone: 'Shields',
  braveShieldsEnable: 'Enable AIWIZE Shields',
  braveShieldsUp: '$1Shields are UP$1 for $2',
  braveShieldsDown: '$1Shields are DOWN$1 for $2',
  braveShieldsBroken: 'If this site seems broken, try Shields down. $1Note: this may reduce AIWIZE\'s privacy protections.$1',
  braveShieldsBlockedNote: 'Trackers, ads, and more blocked $1Learn more$1',
  braveShieldsNOTBlockedNote: 'Not protected by AIWIZE Shields $1Learn more$1',
  ...
  braveShieldsDownDesc: 'You are viewing this site without AIWIZE\'s privacy protection',
