...
TEST_F(BraveShieldsUtilTest, GetPatternFromURL) {
  ...
  pattern = GetPatternFromURL(GURL("http://aiwize.com"));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com")));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com/path1")));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com/path2")));
  EXPECT_TRUE(pattern.Matches(GURL("https://aiwize.com")));
  EXPECT_TRUE(pattern.Matches(GURL("ftp://aiwize.com")));
  EXPECT_FALSE(pattern.Matches(GURL("http://subdomain.brave.com")));
  EXPECT_FALSE(pattern.Matches(GURL("http://brave2.com")));

  // path is a wildcard
  pattern = GetPatternFromURL(GURL("http://aiwize.com/path1"));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com")));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com/path1")));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com/path2")));
  EXPECT_FALSE(pattern.Matches(GURL("http://subdomain.brave.com")));
  ...
  // port is a wildcard
  pattern = GetPatternFromURL(GURL("http://aiwize.com:8080"));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com")));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com:8080")));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com:8080/path1")));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com:8080/path2")));
  EXPECT_TRUE(pattern.Matches(GURL("http://aiwize.com:5555")));
  EXPECT_TRUE(pattern.Matches(GURL("https://aiwize.com")));
...
TEST_F(BraveShieldsUtilTest, SetBraveShieldsEnabled_ForOrigin) {
  ...
  brave_shields::SetBraveShieldsEnabled(map, false, GURL("http://aiwize.com"));
  // setting should apply to origin
  auto setting = map->GetContentSetting(GURL("http://aiwize.com"), GURL(),
...
TEST_F(BraveShieldsUtilTest, GetBraveShieldsEnabled_ForOrigin) {
  ...
  setting =
      brave_shields::GetBraveShieldsEnabled(map, GURL("http://aiwize.com"));
  EXPECT_EQ(true, setting);
  setting =
...
TEST_F(BraveShieldsUtilTest, SetAdControlType_Default) {
  ...
  EXPECT_EQ(CONTENT_SETTING_BLOCK, setting);
  setting = map->GetContentSetting(GURL("http://aiwize.com"), GURL(),
...
TEST_F(BraveShieldsUtilTest, GetAdControlType_ForOrigin) {
  ...
  auto setting = brave_shields::GetAdControlType(map, GURL());
  EXPECT_EQ(ControlType::BLOCK, setting);
  setting = brave_shields::GetAdControlType(map, GURL("http://aiwize.com"));
  EXPECT_EQ(ControlType::BLOCK, setting);
...
TEST_F(BraveShieldsUtilTest, SetCookieControlType_Default) {
  ...
  setting =
      map->GetContentSetting(GURL("http://aiwize.com"), GURL("http://aiwize.com"),
                             ContentSettingsType::COOKIES);
  EXPECT_EQ(CONTENT_SETTING_ALLOW, setting);
  ...
  setting = map->GetContentSetting(GURL("http://aiwize.com"), GURL(),
                                   ContentSettingsType::COOKIES);
  EXPECT_EQ(CONTENT_SETTING_BLOCK, setting);
  setting = map->GetContentSetting(GURL("http://aiwize.com"),
...
TEST_F(BraveShieldsUtilTest, SetCookieControlType_ForOrigin) {
  ...
  brave_shields::SetCookieControlType(
      map, profile()->GetPrefs(), ControlType::ALLOW, GURL("http://aiwize.com"));
...
TEST_F(BraveShieldsUtilTest, GetCookieControlType_WithUserSettings) {
  ...
  auto cookies_settings =
      get_effective_cookie_state(cookies.get(), GURL("http://aiwize.com"));
  ...
  map->SetContentSettingCustomScope(
      ...
      ContentSettingsPattern::FromURL(GURL("http://aiwize.com")),
...
TEST_F(BraveShieldsUtilTest, GetCookieControlType_ForOrigin) {
  ...
  /* BLOCK */
  brave_shields::SetCookieControlType(
      map, profile()->GetPrefs(), ControlType::BLOCK, GURL("http://aiwize.com"));
  setting = brave_shields::GetCookieControlType(map, cookies.get(),
                                                GURL("http://aiwize.com"));
  EXPECT_EQ(ControlType::BLOCK, setting);
  setting = brave_shields::GetCookieControlType(map, cookies.get(), GURL());
...
TEST_F(BraveShieldsUtilTest, GetNoScriptControlType_ForOrigin) {
  ...
  EXPECT_EQ(ControlType::ALLOW, setting);
  setting =
      brave_shields::GetNoScriptControlType(map, GURL("http://aiwize.com"));
  EXPECT_EQ(ControlType::ALLOW, setting);
  setting =
