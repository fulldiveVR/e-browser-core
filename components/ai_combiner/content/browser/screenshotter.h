#ifndef BRAVE_COMPONENTS_AI_COMBINER_CONTENT_BROWSER_SCREENSHOTTER_H__
#define BRAVE_COMPONENTS_AI_COMBINER_CONTENT_BROWSER_SCREENSHOTTER_H__
...
class Screenshotter : public paint_preview::PaintPreviewBaseService {
 public:
  Screenshotter(bool capture_visible_bounds);
  Screenshotter(const Screenshotter&) = delete;
  Screenshotter& operator=(const Screenshotter&) = delete;
 ...
 private:
  ...
  bool capture_visible_bounds_;

  base::WeakPtrFactory<Screenshotter> weak_ptr_factory_{this};
};

}  // namespace ai_chat
#endif  // BRAVE_COMPONENTS_AI_COMBINER_CONTENT_BROWSER_SCREENSHOTTER_H__
