...
inline constexpr char kDailyAsked[] = "aiwize.brave_search.daily_asked";
inline constexpr char kTotalAsked[] = "aiwize.brave_search.total_asked";
#if BUILDFLAG(IS_ANDROID)
inline constexpr char kFetchFromNative[] =
    "aiwize.brave_search.fetch_se_from_native";
#endif
