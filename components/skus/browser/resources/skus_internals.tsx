...
function App() {
  ...
  return (
    <Container>
      ...
      <ButtonContainer>
        <button onClick={() => {
            if (window.confirm('Resetting SKUs state will count the next sign in for account.tau-browser.ru as a new device. If you do this more than once you may run out of devices/credentials. Are you sure you want to reset SKUs state?')) {
              resetSkusState()
            }
          }}>
          Reset SKUs state
