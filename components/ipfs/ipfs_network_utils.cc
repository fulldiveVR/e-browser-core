  ...
  return net::DefineNetworkTrafficAnnotation("ipfs_service", R"(
          semantics {
            ...
            description:
              ...
              "on behalf of the user interacting with the actions in aiwize://ipfs."
            trigger:
              "Triggered by actions in aiwize://ipfs."
            data:
          ...
          policy {
            cookies_allowed: NO
            setting:
              "You can enable or disable this feature in aiwize://settings."
