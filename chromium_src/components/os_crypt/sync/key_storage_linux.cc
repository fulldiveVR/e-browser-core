...
#define BRAVE_KEY_STORAGE_LINUX                             \
  const char KeyStorageLinux::kFolderName[] = "TauBrowser Keys"; \
  const char KeyStorageLinux::kKey[] = "TauBrowser Safe Storage";
...
#define BRAVE_KEY_STORAGE_LINUX_CREATE_SERVICE_INTERNAL                       \
  static const base::NoDestructor<std::string> kDefaultApplicationName("taubrowser");
// clang-format on
