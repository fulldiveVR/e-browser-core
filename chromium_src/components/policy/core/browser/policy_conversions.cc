...
constexpr int kAIWIZEPolicySourceRestrictedManagedGuest =
    IDS_POLICY_SOURCE_RESTRICTED_MANAGED_GUEST_SESSION_OVERRIDE;

// Override macro: inject your AIWIZE entry right after EnterpriseDefault
...
#define IDS_POLICY_SOURCE_RESTRICTED_MANAGED_GUEST_SESSION_OVERRIDE \
  kAIWIZEPolicySourceRestrictedManagedGuest                          \
  }                                                                 \
  , {                                                               \
    "policySourceAIWIZE", IDS_POLICY_SOURCE_BRAVE
