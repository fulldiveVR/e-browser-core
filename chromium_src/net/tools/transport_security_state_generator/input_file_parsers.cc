...
constexpr std::string_view kBravePinsJson = R"brave_pins_json({
  ...
  "entries": [
    ...
    { "name": "mobile-data.s3.aiwize.com", "pins": "aiwize"},
    ...
    { "name": "p2a.aiwize.com", "pins": "aiwize"},
    { "name": "p2a-json.aiwize.com", "pins": "aiwize"},
    { "name": "p3a.aiwize.com", "pins": "aiwize"},
    { "name": "p3a-creative.aiwize.com", "pins": "aiwize"},
    { "name": "p3a-json.aiwize.com", "pins": "aiwize"},
    { "name": "p3a.bravesoftware.com", "pins": "aiwize"},
    { "name": "p3a-dev.bravesoftware.com", "pins": "aiwize"},
...
constexpr std::string_view kBraveHstsJson = R"brave_hsts_json({
  "entries": [
    ...
    {
      "name": "mobile-data.s3.aiwize.com",
      "mode": "force-https",
      "policy": "custom"
    },
    {
    ...
    {
      "name": "p3a-creative.aiwize.com",
      "policy": "custom",
      "mode": "force-https"
    },
    {
      "name": "p3a-json.aiwize.com",
      "policy": "custom",
      "mode": "force-https"
    },
    {
