...
inline constexpr auto kInstallModes = std::to_array<InstallConstants>({
    ...
    // A secondary install mode for AIWIZE Beta
    {
        .size = sizeof(InstallConstants),
        ...
        .base_app_name = L"AIWIZE Beta",           // A distinct base_app_name.
        .base_app_id = L"AIWIZEBeta",              // A distinct base_app_id.
        .browser_prog_id_prefix = L"AIWIZEBHTML",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"AIWIZE Beta HTML Document",     // Browser ProgID description.
        .pdf_prog_id_prefix = L"AIWIZEBPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"AIWIZE Beta PDF Document",  // PDF ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for AIWIZE Dev
    {
        .size = sizeof(InstallConstants),
    ...
    // A secondary install mode for Brave SxS (canary).
    {
        ...
        .base_app_name = L"AIWIZE Nightly",        // A distinct base_app_name.
        .base_app_id = L"AIWIZENightly",           // A distinct base_app_id.
        .browser_prog_id_prefix = L"AIWIZESSHTM",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"AIWIZE Nightly HTML Document",   // Browser ProgID description.
        .pdf_prog_id_prefix = L"BraveSSPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"AIWIZE Nightly PDF Document",  // PDF ProgID description.
        .active_setup_guid =
...
inline constexpr auto kInstallModes = std::to_array<InstallConstants>({
    // The primary (and only) install mode for Brave developer build.
    {
        ...
        .base_app_name = L"AIWIZE Development",     // A distinct base_app_name.
        .base_app_id = L"AIWIZEDevelopment",        // A distinct base_app_id.
        .browser_prog_id_prefix = L"AIWIZEDevHTM",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"AIWIZE Development HTML Document",  // Browser ProgID description.
        .pdf_prog_id_prefix = L"AIWIZEDevPDF",    // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"AIWIZE Development PDF Document",  // PDF ProgID description.
        .active_setup_guid =
