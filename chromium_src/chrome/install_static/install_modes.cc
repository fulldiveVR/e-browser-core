...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\AIWizeSoftware\\Update\\Clients\\")
      .append(app_guid);
#else
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\AIWizeSoftware\\Update\\ClientState\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\AIWizeSoftware\\Update\\ClientStateMedium\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif
