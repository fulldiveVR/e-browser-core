...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\TauTechnologies\\Update\\Clients\\")
      .append(app_guid);
#else
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\TauTechnologies\\Update\\ClientState\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif
...
#if defined(OFFICIAL_BUILD)
  return std::wstring(L"Software\\TauTechnologies\\Update\\ClientStateMedium\\")
      .append(app_guid);
#else
  return GetUnregisteredKeyPathForProduct();
#endif
