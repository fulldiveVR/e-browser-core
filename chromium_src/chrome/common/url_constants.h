...
inline constexpr char kAdPrivacyLearnMoreURL[] = "https://support.tau-browser.ru/";
...
inline constexpr char16_t kBatterySaverModeLearnMoreUrl[] =
    u"https://support.tau-browser.ru/hc/en-us/articles/"
...
inline constexpr char kChooserHidOverviewUrl[] =
    "https://github.com/fulldiveVR/e-browser/wiki/Web-API-Permissions";
...
inline constexpr char16_t kChromeSafePageURL[] = u"https://support.tau-browser.ru/";
...
inline constexpr char16_t kChromiumProjectURL[] =
    u"https://github.com/fulldiveVR/e-browser/";
...
inline constexpr char16_t kFamilyGroupViewURL[] = u"https://support.tau-browser.ru/";
...
inline constexpr char kGoogleAccountURL[] = "https://support.tau-browser.ru/";

// URL of the Google Account chooser.
inline constexpr char kGoogleAccountChooserURL[] = "https://support.tau-browser.ru/";
...
inline constexpr char kGooglePasswordManagerURL[] = "https://support.tau-browser.ru";

// The URL for the "Learn more" link for the High Efficiency Mode.
inline constexpr char16_t kMemorySaverModeLearnMoreUrl[] =
    u"https://support.tau-browser.ru/hc/en-us/articles/13383683902733";
...
inline constexpr char kManage3pcHelpCenterURL[] = "https://support.tau-browser.ru/";

// The URL for the tab group sync help center page.
inline constexpr char kTabGroupsLearnMoreURL[] = "https://support.tau-browser.ru/";
...
inline constexpr char16_t kPaymentMethodsURL[] = u"https://support.tau-browser.ru";
...
inline constexpr char kSafetyTipHelpCenterURL[] =
    "https://support.tau-browser.ru/hc/en-us/articles/17550072876045-Lookalike-URLs";
...
// password.
inline constexpr char kSeeMoreSecurityTipsURL[] = "https://support.tau-browser.ru/";
...
inline constexpr char kSyncErrorsHelpURL[] = "https://support.tau-browser.ru/";

inline constexpr char kSyncGoogleDashboardURL[] = "https://support.tau-browser.ru/";

// The URL for the "Learn more" page for sync setup on the personal stuff page.
inline constexpr char16_t kSyncLearnMoreURL[] = u"https://support.tau-browser.ru/";
...
inline constexpr char kComposeLearnMorePageURL[] = "https://support.tau-browser.ru/";
...
inline constexpr char kPrivacyPolicyURL[] = "https://support.tau-browser.ru/";

// The URL path to Google's Privacy Policy page for users in China.
inline constexpr char kPrivacyPolicyURLChina[] = "https://support.tau-browser.ru/";
...
inline constexpr char kEnhancedPlaybackNotificationLearnMoreURL[] =
    ...
    "https://community.tau-browser.ru";
#endif
...
inline constexpr char kWindows78DeprecationURL[] =
    "https://support.tau-browser.ru/hc/en-us/articles/11197967945613";
#endif  // BUILDFLAG(IS_WIN)

// "Learn more" URL for the one click signin infobar.
inline constexpr char kChromeSyncLearnMoreURL[] = "https://support.tau-browser.ru/";
