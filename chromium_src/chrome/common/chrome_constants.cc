...
const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("taubrowser");
const base::FilePath::CharType kHelperProcessExecutableName[] =
...
#elif BUILDFLAG(IS_ANDROID)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("taubrowser");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("taubrowser");
#elif BUILDFLAG(IS_POSIX)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("taubrowser");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("taubrowser");
#endif  // OS_*
