...
const wchar_t kGoogleUpdateSetupExe[] = L"AIWizeUpdateSetup.exe";
const wchar_t kRegPathClients[] = L"Software\\AIWize\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\AIWize\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\AIWize\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\AIWize\\Update";
