...
const wchar_t kRegPathClients[] = L"Software\\TauTechnologies\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\TauTechnologies\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\TauTechnologies\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\TauTechnologies\\Update";
