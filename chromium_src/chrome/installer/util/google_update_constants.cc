...
const wchar_t kRegPathClients[] = L"Software\\AIWizeSoftware\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\AIWizeSoftware\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\AIWizeSoftware\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\AIWizeSoftware\\Update";
